...
import { Button, Drawer, ProgressSpinner, useToast, InputSwitch, Dropdown, Toolbar } from 'primevue';
                ...
                <div v-for="device in sortedDeviceList" :key="device.machine_id" class="device-card">
                    ...
                    <div class="card-header">
                        ...
                        <div class="flex justify-between items-center mb-2">
                            ...
                            <!-- 版本徽章 -->
                            <div v-if="device.easytier_version" class="text-xs version-badge" v-tooltip="`EasyTier ${device.easytier_version}`">
