            ...
            <ul class="space-y-2 font-medium">
                <li>
                    <Button variant="text" class="w-full justify-start gap-x-3 pl-1.5 sidebar-button"
                        severity="contrast" @click="router.push({ name: 'ipwhitelist' })">
                        <i class="pi pi-shield text-xl"></i>
                        <span class="mb-0.5">{{ t('web.main.ipwhitelist') }}</span>
                    </Button>
                </li>
                <li>
                    <Button variant="text" class="w-full justify-start gap-x-3 pl-1.5 sidebar-button"
                ...
                <li>
                    <Button variant="text" class="w-full justify-start gap-x-3 pl-1.5 sidebar-button"
                        severity="contrast" @click="router.push({ name: 'agents' })">
                        <i class="pi pi-sitemap text-xl"></i>
                        <span class="mb-0.5">{{ t('web.main.agents') }}</span>
                    </Button>
                </li>
                <li>
                    <Button variant="text" class="w-full justify-start gap-x-3 pl-1.5 sidebar-button"
